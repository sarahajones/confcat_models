...
if computeLambda
   ...
   if boundsInA
      ...
      iextraindex = (nnzAineqindex+1:nnzAineqindex+extraAineqvars);
      lambda.upper(ilbinfubfin) = full(-y(iextraindex));
