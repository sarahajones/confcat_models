...
averageModelFit = zeros(2,1); %adjust for number of models
for iParticipant = 1:52 %how many participants do we have
    for jModel = 1:1 %adjust for number of models
        likeli = zeros(1,1); %adjust for number of runs
